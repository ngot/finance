...
const translations = {
    en: {
        ...
        deductible_expenses_optimization_suggestions: "Deductible Expenses Optimization Suggestions",
        deduction_optimization: "Deduction Optimization",
        main_deductible_expense_categories: "Main Deductible Expense Categories",
        deduction_optimization_strategies: "Deduction Optimization Strategies",
        important_notes: "Important Notes",
        loan_interest: "Loan Interest",
        loan_interest_desc: "Interest portion of investment property loans is fully deductible",
        property_management_fees: "Property Management Fees",
        property_management_fees_desc: "Strata fees and other property management costs for apartments",
        council_fees: "Council Fees",
        council_fees_desc: "Council rates, water rates and other government fees",
        insurance_costs: "Insurance Costs",
        insurance_costs_desc: "Landlord insurance premiums",
        maintenance_costs: "Maintenance Costs",
        maintenance_costs_desc: "Repair and maintenance expenses",
        agent_fees: "Agent Fees",
        agent_fees_desc: "Rental management fees",
        record_keeping: "Record Keeping",
        record_keeping_desc: "Keep all expense receipts and invoices",
        professional_consultation: "Professional Consultation",
        professional_consultation_desc: "Regular consultation with tax advisors",
        expense_classification: "Expense Classification",
        expense_classification_desc: "Distinguish between deductible and non-deductible expenses",
        timing_planning: "Timing Planning",
        timing_planning_desc: "Properly schedule repairs and improvements",
        capital_expenditure: "Capital Expenditure",
        capital_expenditure_desc: "Major improvement projects may not be immediately deductible",
        personal_use: "Personal Use",
        personal_use_desc: "If there is personal use, calculate proportionally",
        ato_regulations: "ATO Regulations",
        ato_regulations_desc: "Follow the latest Australian Tax Office regulations",
        professional_advice: "Professional Advice",
        professional_advice_desc: "Consult professionals for complex situations",
        cash_flow_characteristics: "Cash Flow Characteristics",
        positive_cash_flow_years: "Positive Cash Flow Years",
        total_investment_period: "Total {years} year investment period",
        payback_period: "Payback Period",
        not_recovered: "Not Recovered",
        cumulative_cash_flow_positive_time: "Time for cumulative cash flow to turn positive",
    ...
    zh: {
        ...
        deductible_expenses_optimization_suggestions: "可抵扣费用优化建议",
        deduction_optimization: "抵扣优化",
        main_deductible_expense_categories: "主要可抵扣费用类别",
        deduction_optimization_strategies: "抵扣优化策略",
        important_notes: "注意事项",
        loan_interest: "贷款利息",
        loan_interest_desc: "投资房贷款的利息部分可全额抵扣",
        property_management_fees: "物业管理费",
        property_management_fees_desc: "公寓的strata fees等物业费用",
        council_fees: "市政费用",
        council_fees_desc: "council rates, water rates等政府费用",
        insurance_costs: "保险费用",
        insurance_costs_desc: "房东保险premiums",
        maintenance_costs: "维护费用",
        maintenance_costs_desc: "修理和维护成本",
        agent_fees: "中介费用",
        agent_fees_desc: "租赁管理费用",
        record_keeping: "记录保存",
        record_keeping_desc: "保留所有费用收据和发票",
        professional_consultation: "专业咨询",
        professional_consultation_desc: "定期咨询税务顾问",
        expense_classification: "费用分类",
        expense_classification_desc: "区分可抵扣和不可抵扣费用",
        timing_planning: "时间规划",
        timing_planning_desc: "合理安排维修和改善时间",
        capital_expenditure: "资本性支出",
        capital_expenditure_desc: "大型改善项目可能不能立即抵扣",
        personal_use: "个人使用",
        personal_use_desc: "如有个人使用需按比例计算",
        ato_regulations: "ATO规定",
        ato_regulations_desc: "遵循澳洲税务局最新规定",
        professional_advice: "专业建议",
        professional_advice_desc: "复杂情况建议咨询专业人士",
        cash_flow_characteristics: "现金流特征",
        positive_cash_flow_years: "正现金流年数",
        total_investment_period: "共{years}年投资期",
        payback_period: "回本时间",
        not_recovered: "未回本",
        cumulative_cash_flow_positive_time: "累计现金流转正时间",
